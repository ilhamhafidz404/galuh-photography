    ...
    >
      <div>
        ...
        >
          <div class="px-7 py-5">
            ...
            <a
              ...
              class="
                ...
                dark:border-white dark:hover:border-transparent
          ...
          <div class="bg-gray-50 dark:bg-slate-600 px-5 py-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
            ...
            <p class="text-xs mt-3 text-center">
              Cetak foto ukuran 4-10R, dapat bonus foto singel sampai 15 foto
              dan tersedia sampai 3 background
            </p>
          </div>
        </div>
      </div>
